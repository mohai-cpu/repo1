//package cn.itcast.study.sftp.utils;
//
...
//            session.connect();
//            //创建sftp通信通道
//            Channel channel = session.openChannel("cn/itcast/study/sftp");
//            channel.connect();
//            sftp = (ChannelSftp) channel;
//            logger.info("cn.itcast.study.sftp server connect success !!");
...
//            if(sftp.isConnected()){
//                sftp.disconnect();
//                logger.info("cn.itcast.study.sftp is close already");
//            }
//        }
//        if(session != null){
