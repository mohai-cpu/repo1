package cn.itcast.study.sftp.config;
...
public class SFTP {
    ...
    @Value("${cn.itcast.study.sftp.remotepath}")
    private String remotepath;

    @Value("${cn.itcast.study.sftp.localpath}")
    private String localpath;

    @Value("${cn.itcast.study.sftp.filenames}")
    ...
    public ChannelSftp connect(SftpConfig sftpConfig) {
        ...
        try {
            ...
            Channel channel = sshSession.openChannel("cn/itcast/study/sftp");
            channel.connect();
